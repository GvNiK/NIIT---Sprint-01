...
public class LevelVFXController
{
	...
	GuardManager guardManager, GuardEvents guardEvents) 	//Extra
	{
		...
		player.OnEquipmentCollidedWithEnvironment += (type, collisionPos) =>	//Extra
		{
			switch(type)
			{
		...
		//Extra
		/*player.OnEquipmentCollidedWithGuard += (guard, type, collisionPos) =>	
		{
