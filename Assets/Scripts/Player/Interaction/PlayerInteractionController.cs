...
public class PlayerInteractionController
{
	...
	public PlayerInteractionController(Transform levelObjects, Transform playerTransform, 
		PlayerCollision collision,  PlayerObjectData playerObjectData)
    {
		...
		behaviourFactory = new PlayerInteractionBehaviourFactory();
